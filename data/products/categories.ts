...
export const categories: CategoryData[] = [
  {
    slug: 'bicycle-tubeless-valve',
    name: { en: 'Bicycle Tubeless Valves', 'zh-TW': '自行車無內胎氣嘴閥' },
    description: {
  ...
  {
    slug: 'motorcycle-valve',
    name: { en: 'Motorcycle Valves', 'zh-TW': '機車氣嘴閥' },
    description: {
      en: '7 models of tire valves designed for motorcycle applications.',
      'zh-TW': '7 款專為機車設計的輪胎氣嘴閥。',
    },
    productCount: 7,
    featuredProducts: [],
  ...
  },
  {
    ...
    name: { en: 'Truck & Bus Valves', 'zh-TW': '大客車與貨車氣嘴閥' },
    description: {
  ...
  },
  {
    ...
    name: { en: 'Invisible Valves', 'zh-TW': '隱形氣嘴閥' },
    description: {
      en: 'Aesthetic hidden-stem valve designs where the valve stem is concealed as an extender.',
      'zh-TW': '氣嘴桿隱藏設計，外觀美觀的隱形氣嘴閥。',
    },
    productCount: 4,
    featuredProducts: [],
  ...
  {
    slug: 'tractor-valve',
    name: { en: 'Large Bore Tractor Valves', 'zh-TW': '大口徑農機氣嘴閥' },
    description: {
  ...
  },
  {
    ...
    name: { en: 'Truck Valve Extensions', 'zh-TW': '貨車氣嘴延長管' },
    description: {
  ...
  },
  {
    ...
    name: { en: 'Industrial Valves', 'zh-TW': '工業用氣嘴閥' },
    description: {
      en: 'Specialty valves for industrial applications.',
      'zh-TW': '特殊工業用途氣嘴閥。',
    },
    productCount: 4,
    featuredProducts: [],
  ...
  },
  {
    ...
    name: { en: 'Special Valves & Caps', 'zh-TW': '特殊氣嘴與氣嘴帽' },
    description: {
  ...
  {
    slug: 'alloy-lug-nuts',
    name: { en: 'Alloy Lug Nuts for Wheels', 'zh-TW': '鋁合金輪圈螺帽' },
    description: {
      en: '7075-T6 aluminum alloy lug nuts with 83,000 PSI tensile strength.',
      'zh-TW': '7075-T6 鋁合金輪圈螺帽，抗拉強度 83,000 PSI。',
    },
    productCount: 5,
    featuredProducts: [],
  ...
  {
    slug: 'rim-hole-plug',
    name: { en: 'Rim Hole Plugs', 'zh-TW': '輪圈孔塞' },
    description: {
      en: 'Rim hole sealing solutions.',
      'zh-TW': '輪圈孔密封解決方案。',
    },
    productCount: 2,
    featuredProducts: [],
  ...
  },
  {
    ...
    name: { en: 'Motorcycle Valve Extensions', 'zh-TW': '機車氣嘴延長管' },
    description: {
