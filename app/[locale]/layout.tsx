...
export async function generateMetadata({
  ...
  return {
    title: {
      default: isZh
        ? '南新林工業 | N.S.-LIN Tire Valve Manufacturer'
        : 'N.S.-LIN Industrial | Tire Valve Manufacturer Since 1980s',
      template: isZh ? '%s | 南新林工業' : '%s | N.S.-LIN Industrial',
    },
    description: isZh
      ? '南新林工業 — 超過40年氣嘴閥製造專業，ISO 9001:2015認證，產品符合TRA、ETRTO、JATMA國際標準。提供OEM/ODM客製服務。'
    ...
    keywords: isZh
      ? ['南新林', '氣嘴閥', '輪胎氣嘴', '台灣氣嘴閥工廠', 'OEM氣嘴', '自行車氣嘴', 'TPMS氣嘴閥', 'ISO認證']
    ...
    openGraph: {
      type: 'website',
      siteName: isZh ? '南新林工業' : 'N.S.-LIN Industrial',
